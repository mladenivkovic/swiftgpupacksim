...
if __name__ == "__main__":
    ...
    for e, experiment in enumerate(EXPERIMENTS):
        ...
        for a, access in enumerate(PART_ACCESS):
            ...
            for s, split in enumerate(LOOP_SPLITS):
                ...
                ax1.plot(
                    layouts,
                    dens_pack_pack / dens_pack_nopack,
                    c=color,
                    ls=ls,
                    label=label,
                    **plotkwargs,
                ...
                ax2.plot(
                    layouts,
                    grad_pack_pack / grad_pack_nopack,
                    c=color,
                    ls=ls,
                    label=label,
                    **plotkwargs,
                ...
                ax3.plot(
                    layouts,
                    forc_pack_pack / forc_pack_nopack,
                    c=color,
                    ls=ls,
                    label=label,
                    **plotkwargs,
                ...
                ax4.plot(
                    layouts,
                    dens_unpack_pack / dens_unpack_nopack,
                    c=color,
                    ls=ls,
                    label=label,
                    **plotkwargs,
                ...
                ax5.plot(
                    layouts,
                    grad_unpack_pack / grad_unpack_nopack,
                    c=color,
                    ls=ls,
                    label=label,
                    **plotkwargs,
                ...
                ax6.plot(
                    layouts,
                    forc_unpack_pack / forc_unpack_nopack,
                    c=color,
                    ls=ls,
                    label=label,
                    **plotkwargs,
    ...
    # leftmost axes
    for ax in [ax1, ax4]:
        ax.set_ylabel(r"$t / t_{\mathrm{pack}} / t_{\mathrm{unpack}}$")
