...
parser = argparse.ArgumentParser(
    ...
    description="""
Compare results of using flushes between copy operations vs not doing that
for different loop splitting variants and different particle memory layouts for
a given experiment and a given particle accessor variant.
...
variants = [variant_dir_suffix, variant_dir_suffix + "_noflush"]
variants_labels = [variant_label_suffix, variant_label_suffix + " no cache flushes"]
...
if __name__ == "__main__":
    ...
    for experiment in EXPERIMENTS:
        for a, access in enumerate(PART_ACCESS):
            ...
            outfname = f"loop_splitting_compare_noflush_{os.path.basename(srcdir)}_{experiment}_{access}"
