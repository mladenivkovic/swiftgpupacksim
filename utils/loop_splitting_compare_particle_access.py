...
parser = argparse.ArgumentParser(
    ...
    description="""
Compare results of different particle access variants for different loop
splitting variants and different particle memory layouts and different particle
accessor variants.
...
parser.add_argument(
    ...
    dest="local",
    action="store_true",
    help="plot outputs for small local test-runs (modifies experiment name and nthreads)",
)
parser.add_argument(
    "--png",
    dest="png",
...
if __name__ == "__main__":
    ...
    for experiment in EXPERIMENTS:
        ...
        outfname = f"loop_splitting_compare_part_access_{os.path.basename(srcdir)}_{experiment}_{nthreads}threads"
