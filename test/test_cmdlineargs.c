...
int main(void){
  ...
  init_params(&params);
  int argc3 = 2;
  char* argv3[] = {"../data/IntelXeonGold5218_64", "--verbose"};
  ...
  init_params(&params);
  int argc4 = 2;
  char* argv4[] = {"../data/IntelXeonGold5218_64", "-h"};
  ...
  init_params(&params);
  int argc5 = 2;
  char* argv5[] = {"../data/IntelXeonGold5218_64", "--help"};
  ...
  init_params(&params);
  int argc6 = 5;
  char* argv6[] = {"../data/IntelXeonGold5218_64", "--help", "-h", "-v", "--verbose"};
