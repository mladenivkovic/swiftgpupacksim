...
int main(void) {
  ...
  init_params(&params);
  int argc2 = 3;
  char *argv2[] = {"swiftgpupack", "../data/IntelXeonGold5218_Gresho64_1thread",
                   "-v"};
  ...
  init_params(&params);
  int argc3 = 3;
  char *argv3[] = {"swiftgpupack", "../data/IntelXeonGold5218_Gresho64_1thread",
                   "--verbose"};
  ...
  init_params(&params);
  int argc4 = 3;
  char *argv4[] = {"swiftgpupack", "../data/IntelXeonGold5218_Gresho64_1thread",
                   "-h"};
  ...
  init_params(&params);
  int argc5 = 3;
  char *argv5[] = {"swiftgpupack", "../data/IntelXeonGold5218_Gresho64_1thread",
                   "--help"};
  ...
  init_params(&params);
  int argc6 = 6;
  char *argv6[] = {"swiftgpupack", "../data/IntelXeonGold5218_Gresho64_1thread",
                   "--help",       "-h",
                   "-v",           "--verbose"};
