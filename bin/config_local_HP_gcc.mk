...
CFLAGS_DEBUG = -g -O0  -fno-lto -I//opt/cuda/include -gdwarf -fvar-tracking-assignments -fomit-frame-pointer -malign-double -fstrict-aliasing -ffast-math -funroll-loops -march=core2 -mavx512vbmi -pthread  -Wall -Wextra -Wno-unused-parameter -Wshadow -Wstrict-prototypes
