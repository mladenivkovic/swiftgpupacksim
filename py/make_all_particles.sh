...
./generate_hydro_part.py -e -g input/SPHENIX_pack_gradient_type.yml -o ../sim/src/realisations/pack_gradient_type
./generate_hydro_part.py -e -g input/SPHENIX_pack_shared.yml -o ../sim/src/realisations/pack_shared
./generate_hydro_part.py -e -g input/SPHENIX_pack_shared_type.yml -o ../sim/src/realisations/pack_shared_type
