  ...
  for loop in "none"; do
    ...
    for dir in EAGLE25_128threads Gresho256_128threads; do
      ...
      for layout in aos soa upstream pack-gradient pack-force pack-shared; do
        ...
        # if [[ ! -f "$outfile" ]]; then
        #   echo running "$ex" ../../data/mad06/$dir --noflush
        #   $ex ../../data/mad06/$dir --noflush
        #   mv results_"$layout".csv "$outfile"
        #   echo written $outfile
        # else
        #   echo found $outfile, not rerunning
