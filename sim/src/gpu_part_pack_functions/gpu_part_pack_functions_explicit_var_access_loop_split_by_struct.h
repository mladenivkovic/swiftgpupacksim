...
/**
 * @file gpu_part_pack_functions_explicit_var_access_loop_split_by_struct.h
 ...
 * split according to underlying data structs.
 */
...
#ifdef SPHENIX_PACK_FORCE_TYPE_PARTICLE
