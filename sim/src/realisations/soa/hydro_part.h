...
#ifndef SWIFT_HYDRO_PART_05847d45e47b9b47b82a02fc014073908d4f3d5a_H
#define SWIFT_HYDRO_PART_05847d45e47b9b47b82a02fc014073908d4f3d5a_H
...
} SWIFT_STRUCT_ALIGN_PART_A_HYDRO;
...
} SWIFT_STRUCT_ALIGN_PART_DIV_V_DT;
...
} SWIFT_STRUCT_ALIGN_PART_DIV_V_PREVIOUS_STEP;
...
} SWIFT_STRUCT_ALIGN_PART_ALPHA_AV;
...
} SWIFT_STRUCT_ALIGN_PART_LAPLACE_U;
...
} SWIFT_STRUCT_ALIGN_PART_ALPHA_DIFF;
...
} SWIFT_STRUCT_ALIGN_PART_DENSITY1;
...
} SWIFT_STRUCT_ALIGN_PART_FORCE1;
...
} SWIFT_STRUCT_ALIGN_PART_DENSITY2;
...
} SWIFT_STRUCT_ALIGN_PART_FORCE2;
...
} SWIFT_STRUCT_ALIGN_PART_DENSITY3;
...
} SWIFT_STRUCT_ALIGN_PART_FORCE3;
...
} SWIFT_STRUCT_ALIGN_PART_DENSITY4;
...
} SWIFT_STRUCT_ALIGN_PART_FORCE4;
...
} SWIFT_STRUCT_ALIGN_PART_FORCE5;
...
} SWIFT_STRUCT_ALIGN_PART_FORCE6;
...
} SWIFT_STRUCT_ALIGN_PART_ADDITIONAL_STRUCTS;
...
} SWIFT_STRUCT_ALIGN_PART_RT_TIME_DATA;
...
} SWIFT_STRUCT_ALIGN_PART_DEPTH_H;
...
} SWIFT_STRUCT_ALIGN_PART_TIME_BIN;
...
} SWIFT_STRUCT_ALIGN_PART_LIMITER_DATA;
...
} SWIFT_STRUCT_ALIGN_PART_TI_DRIFT;
...
} SWIFT_STRUCT_ALIGN_PART_TI_KICK;
...
} SWIFT_STRUCT_ALIGN_PART_DEBUGGING;
...
static __attribute__((always_inline)) INLINE long long
  ...
  const struct part_id* restrict part_id_s = p->_cell_part_arrays->_part_id + p->_cell_offset;
#ifdef SWIFT_DEBUG_CHECKS
  /* Forbid ID = 0 to prevent false positives by forgotten initialisation */
  swift_assert(p->_accessor_id != 0);
  /* Make sure we're accessing the correct data */
...
static __attribute__((always_inline)) INLINE long long*
  ...
  struct part_id* restrict part_id_s = p->_cell_part_arrays->_part_id + p->_cell_offset;
#ifdef SWIFT_DEBUG_CHECKS
  /* Forbid ID = 0 to prevent false positives by forgotten initialisation */
  swift_assert(p->_accessor_id != 0);
  /* Make sure we're accessing the correct data */
...
static __attribute__((always_inline)) INLINE struct gpart*
  ...
  const struct part_gpart* restrict part_gpart_s = p->_cell_part_arrays->_part_gpart + p->_cell_offset;
#ifdef SWIFT_DEBUG_CHECKS
  /* Forbid ID = 0 to prevent false positives by forgotten initialisation */
  swift_assert(p->_accessor_id != 0);
  /* Make sure we're accessing the correct data */
...
static __attribute__((always_inline)) INLINE double*
  ...
  struct part_x* restrict part_x_s = p->_cell_part_arrays->_part_x + p->_cell_offset;
#ifdef SWIFT_DEBUG_CHECKS
  /* Forbid ID = 0 to prevent false positives by forgotten initialisation */
  swift_assert(p->_accessor_id != 0);
  /* Make sure we're accessing the correct data */
...
static __attribute__((always_inline)) INLINE const double*
  ...
  const struct part_x* restrict part_x_s = p->_cell_part_arrays->_part_x + p->_cell_offset;
#ifdef SWIFT_DEBUG_CHECKS
  /* Forbid ID = 0 to prevent false positives by forgotten initialisation */
  swift_assert(p->_accessor_id != 0);
  /* Make sure we're accessing the correct data */
...
static __attribute__((always_inline)) INLINE const float*
  ...
  const struct part_v* restrict part_v_s = p->_cell_part_arrays->_part_v + p->_cell_offset;
#ifdef SWIFT_DEBUG_CHECKS
  /* Forbid ID = 0 to prevent false positives by forgotten initialisation */
  swift_assert(p->_accessor_id != 0);
  /* Make sure we're accessing the correct data */
 ...
 */
static __attribute__((always_inline)) INLINE float
  part_get_v_ind(const struct part *restrict p, const int i) {
  const struct part_v* restrict part_v_s = p->_cell_part_arrays->_part_v + p->_cell_offset;
#ifdef SWIFT_DEBUG_CHECKS
  /* Forbid ID = 0 to prevent false positives by forgotten initialisation */
  swift_assert(p->_accessor_id != 0);
 ...
 */
static __attribute__((always_inline)) INLINE void
  part_set_v_ind(struct part *restrict p, const int i, const float v) {
  struct part_v* restrict part_v_s = p->_cell_part_arrays->_part_v + p->_cell_offset;
#ifdef SWIFT_DEBUG_CHECKS
  /* Forbid ID = 0 to prevent false positives by forgotten initialisation */
  swift_assert(p->_accessor_id != 0);
...
static __attribute__((always_inline)) INLINE float*
  ...
  struct part_a_hydro* restrict part_a_hydro_s = p->_cell_part_arrays->_part_a_hydro + p->_cell_offset;
#ifdef SWIFT_DEBUG_CHECKS
  /* Forbid ID = 0 to prevent false positives by forgotten initialisation */
  swift_assert(p->_accessor_id != 0);
  /* Make sure we're accessing the correct data */
...
static __attribute__((always_inline)) INLINE const float*
  ...
  const struct part_a_hydro* restrict part_a_hydro_s = p->_cell_part_arrays->_part_a_hydro + p->_cell_offset;
#ifdef SWIFT_DEBUG_CHECKS
  /* Forbid ID = 0 to prevent false positives by forgotten initialisation */
  swift_assert(p->_accessor_id != 0);
  /* Make sure we're accessing the correct data */
 ...
 */
static __attribute__((always_inline)) INLINE float
  part_get_a_hydro_ind(const struct part *restrict p, const int i) {
  const struct part_a_hydro* restrict part_a_hydro_s = p->_cell_part_arrays->_part_a_hydro + p->_cell_offset;
#ifdef SWIFT_DEBUG_CHECKS
  /* Forbid ID = 0 to prevent false positives by forgotten initialisation */
  swift_assert(p->_accessor_id != 0);
  ...
  if(part_a_hydro_s->_accessor_id != p->_accessor_id)
    error("Accessor IDs not equal: %lld %lld", part_a_hydro_s->_accessor_id, p->_accessor_id);
#endif
  return part_a_hydro_s->_a_hydro[i];
}
 ...
 */
static __attribute__((always_inline)) INLINE void
  part_set_a_hydro_ind(struct part *restrict p, const int i, const float a_hydro) {
  struct part_a_hydro* restrict part_a_hydro_s = p->_cell_part_arrays->_part_a_hydro + p->_cell_offset;
#ifdef SWIFT_DEBUG_CHECKS
  /* Forbid ID = 0 to prevent false positives by forgotten initialisation */
  swift_assert(p->_accessor_id != 0);
...
static __attribute__((always_inline)) INLINE float
  ...
  const struct part_mass* restrict part_mass_s = p->_cell_part_arrays->_part_mass + p->_cell_offset;
#ifdef SWIFT_DEBUG_CHECKS
  /* Forbid ID = 0 to prevent false positives by forgotten initialisation */
  swift_assert(p->_accessor_id != 0);
  /* Make sure we're accessing the correct data */
...
static __attribute__((always_inline)) INLINE float
  ...
  const struct part_h* restrict part_h_s = p->_cell_part_arrays->_part_h + p->_cell_offset;
#ifdef SWIFT_DEBUG_CHECKS
  /* Forbid ID = 0 to prevent false positives by forgotten initialisation */
  swift_assert(p->_accessor_id != 0);
  /* Make sure we're accessing the correct data */
...
static __attribute__((always_inline)) INLINE float*
  ...
  struct part_h* restrict part_h_s = p->_cell_part_arrays->_part_h + p->_cell_offset;
#ifdef SWIFT_DEBUG_CHECKS
  /* Forbid ID = 0 to prevent false positives by forgotten initialisation */
  swift_assert(p->_accessor_id != 0);
  /* Make sure we're accessing the correct data */
...
static __attribute__((always_inline)) INLINE float
  ...
  const struct part_u* restrict part_u_s = p->_cell_part_arrays->_part_u + p->_cell_offset;
#ifdef SWIFT_DEBUG_CHECKS
  /* Forbid ID = 0 to prevent false positives by forgotten initialisation */
  swift_assert(p->_accessor_id != 0);
  /* Make sure we're accessing the correct data */
...
static __attribute__((always_inline)) INLINE float
  ...
  const struct part_u_dt* restrict part_u_dt_s = p->_cell_part_arrays->_part_u_dt + p->_cell_offset;
#ifdef SWIFT_DEBUG_CHECKS
  /* Forbid ID = 0 to prevent false positives by forgotten initialisation */
  swift_assert(p->_accessor_id != 0);
  /* Make sure we're accessing the correct data */
...
static __attribute__((always_inline)) INLINE float*
  ...
  struct part_u_dt* restrict part_u_dt_s = p->_cell_part_arrays->_part_u_dt + p->_cell_offset;
#ifdef SWIFT_DEBUG_CHECKS
  /* Forbid ID = 0 to prevent false positives by forgotten initialisation */
  swift_assert(p->_accessor_id != 0);
  /* Make sure we're accessing the correct data */
...
static __attribute__((always_inline)) INLINE float
  ...
  const struct part_rho* restrict part_rho_s = p->_cell_part_arrays->_part_rho + p->_cell_offset;
#ifdef SWIFT_DEBUG_CHECKS
  /* Forbid ID = 0 to prevent false positives by forgotten initialisation */
  swift_assert(p->_accessor_id != 0);
  /* Make sure we're accessing the correct data */
...
static __attribute__((always_inline)) INLINE float
  ...
  const struct part_div_v* restrict part_div_v_s = p->_cell_part_arrays->_part_div_v + p->_cell_offset;
#ifdef SWIFT_DEBUG_CHECKS
  /* Forbid ID = 0 to prevent false positives by forgotten initialisation */
  swift_assert(p->_accessor_id != 0);
  /* Make sure we're accessing the correct data */
...
static __attribute__((always_inline)) INLINE float*
  ...
  struct part_div_v* restrict part_div_v_s = p->_cell_part_arrays->_part_div_v + p->_cell_offset;
#ifdef SWIFT_DEBUG_CHECKS
  /* Forbid ID = 0 to prevent false positives by forgotten initialisation */
  swift_assert(p->_accessor_id != 0);
  /* Make sure we're accessing the correct data */
...
static __attribute__((always_inline)) INLINE float
  ...
  const struct part_div_v_dt* restrict part_div_v_dt_s = p->_cell_part_arrays->_part_div_v_dt + p->_cell_offset;
#ifdef SWIFT_DEBUG_CHECKS
  /* Forbid ID = 0 to prevent false positives by forgotten initialisation */
  swift_assert(p->_accessor_id != 0);
  /* Make sure we're accessing the correct data */
...
static __attribute__((always_inline)) INLINE float
  ...
  const struct part_div_v_previous_step* restrict part_div_v_previous_step_s = p->_cell_part_arrays->_part_div_v_previous_step + p->_cell_offset;
#ifdef SWIFT_DEBUG_CHECKS
  /* Forbid ID = 0 to prevent false positives by forgotten initialisation */
  swift_assert(p->_accessor_id != 0);
  /* Make sure we're accessing the correct data */
...
static __attribute__((always_inline)) INLINE float*
  ...
  struct part_div_v_previous_step* restrict part_div_v_previous_step_s = p->_cell_part_arrays->_part_div_v_previous_step + p->_cell_offset;
#ifdef SWIFT_DEBUG_CHECKS
  /* Forbid ID = 0 to prevent false positives by forgotten initialisation */
  swift_assert(p->_accessor_id != 0);
  /* Make sure we're accessing the correct data */
...
static __attribute__((always_inline)) INLINE float
  ...
  const struct part_alpha_av* restrict part_alpha_av_s = p->_cell_part_arrays->_part_alpha_av + p->_cell_offset;
#ifdef SWIFT_DEBUG_CHECKS
  /* Forbid ID = 0 to prevent false positives by forgotten initialisation */
  swift_assert(p->_accessor_id != 0);
  /* Make sure we're accessing the correct data */
...
static __attribute__((always_inline)) INLINE float
  ...
  const struct part_v_sig* restrict part_v_sig_s = p->_cell_part_arrays->_part_v_sig + p->_cell_offset;
#ifdef SWIFT_DEBUG_CHECKS
  /* Forbid ID = 0 to prevent false positives by forgotten initialisation */
  swift_assert(p->_accessor_id != 0);
  /* Make sure we're accessing the correct data */
...
static __attribute__((always_inline)) INLINE float*
  ...
  struct part_v_sig* restrict part_v_sig_s = p->_cell_part_arrays->_part_v_sig + p->_cell_offset;
#ifdef SWIFT_DEBUG_CHECKS
  /* Forbid ID = 0 to prevent false positives by forgotten initialisation */
  swift_assert(p->_accessor_id != 0);
  /* Make sure we're accessing the correct data */
...
static __attribute__((always_inline)) INLINE float
  ...
  const struct part_laplace_u* restrict part_laplace_u_s = p->_cell_part_arrays->_part_laplace_u + p->_cell_offset;
#ifdef SWIFT_DEBUG_CHECKS
  /* Forbid ID = 0 to prevent false positives by forgotten initialisation */
  swift_assert(p->_accessor_id != 0);
  /* Make sure we're accessing the correct data */
...
static __attribute__((always_inline)) INLINE float
  ...
  const struct part_alpha_diff* restrict part_alpha_diff_s = p->_cell_part_arrays->_part_alpha_diff + p->_cell_offset;
#ifdef SWIFT_DEBUG_CHECKS
  /* Forbid ID = 0 to prevent false positives by forgotten initialisation */
  swift_assert(p->_accessor_id != 0);
  /* Make sure we're accessing the correct data */
...
static __attribute__((always_inline)) INLINE float*
  ...
  struct part_alpha_diff* restrict part_alpha_diff_s = p->_cell_part_arrays->_part_alpha_diff + p->_cell_offset;
#ifdef SWIFT_DEBUG_CHECKS
  /* Forbid ID = 0 to prevent false positives by forgotten initialisation */
  swift_assert(p->_accessor_id != 0);
  /* Make sure we're accessing the correct data */
...
static __attribute__((always_inline)) INLINE float
  ...
  const struct part_density1* restrict part_density1_s = p->_cell_part_arrays->_part_density1 + p->_cell_offset;
#ifdef SWIFT_DEBUG_CHECKS
  /* Forbid ID = 0 to prevent false positives by forgotten initialisation */
  swift_assert(p->_accessor_id != 0);
  /* Make sure we're accessing the correct data */
...
static __attribute__((always_inline)) INLINE float
  ...
  const struct part_force1* restrict part_force1_s = p->_cell_part_arrays->_part_force1 + p->_cell_offset;
#ifdef SWIFT_DEBUG_CHECKS
  /* Forbid ID = 0 to prevent false positives by forgotten initialisation */
  swift_assert(p->_accessor_id != 0);
  /* Make sure we're accessing the correct data */
...
static __attribute__((always_inline)) INLINE float*
  ...
  struct part_force1* restrict part_force1_s = p->_cell_part_arrays->_part_force1 + p->_cell_offset;
#ifdef SWIFT_DEBUG_CHECKS
  /* Forbid ID = 0 to prevent false positives by forgotten initialisation */
  swift_assert(p->_accessor_id != 0);
  /* Make sure we're accessing the correct data */
...
static __attribute__((always_inline)) INLINE float
  ...
  const struct part_density2* restrict part_density2_s = p->_cell_part_arrays->_part_density2 + p->_cell_offset;
#ifdef SWIFT_DEBUG_CHECKS
  /* Forbid ID = 0 to prevent false positives by forgotten initialisation */
  swift_assert(p->_accessor_id != 0);
  /* Make sure we're accessing the correct data */
...
static __attribute__((always_inline)) INLINE float
  ...
  const struct part_force2* restrict part_force2_s = p->_cell_part_arrays->_part_force2 + p->_cell_offset;
#ifdef SWIFT_DEBUG_CHECKS
  /* Forbid ID = 0 to prevent false positives by forgotten initialisation */
  swift_assert(p->_accessor_id != 0);
  /* Make sure we're accessing the correct data */
...
static __attribute__((always_inline)) INLINE float*
  ...
  struct part_force2* restrict part_force2_s = p->_cell_part_arrays->_part_force2 + p->_cell_offset;
#ifdef SWIFT_DEBUG_CHECKS
  /* Forbid ID = 0 to prevent false positives by forgotten initialisation */
  swift_assert(p->_accessor_id != 0);
  /* Make sure we're accessing the correct data */
...
static __attribute__((always_inline)) INLINE float
  ...
  const struct part_density3* restrict part_density3_s = p->_cell_part_arrays->_part_density3 + p->_cell_offset;
#ifdef SWIFT_DEBUG_CHECKS
  /* Forbid ID = 0 to prevent false positives by forgotten initialisation */
  swift_assert(p->_accessor_id != 0);
  /* Make sure we're accessing the correct data */
...
static __attribute__((always_inline)) INLINE float*
  ...
  struct part_density3* restrict part_density3_s = p->_cell_part_arrays->_part_density3 + p->_cell_offset;
#ifdef SWIFT_DEBUG_CHECKS
  /* Forbid ID = 0 to prevent false positives by forgotten initialisation */
  swift_assert(p->_accessor_id != 0);
  /* Make sure we're accessing the correct data */
...
static __attribute__((always_inline)) INLINE float
  ...
  const struct part_force3* restrict part_force3_s = p->_cell_part_arrays->_part_force3 + p->_cell_offset;
#ifdef SWIFT_DEBUG_CHECKS
  /* Forbid ID = 0 to prevent false positives by forgotten initialisation */
  swift_assert(p->_accessor_id != 0);
  /* Make sure we're accessing the correct data */
...
static __attribute__((always_inline)) INLINE float*
  ...
  struct part_density4* restrict part_density4_s = p->_cell_part_arrays->_part_density4 + p->_cell_offset;
#ifdef SWIFT_DEBUG_CHECKS
  /* Forbid ID = 0 to prevent false positives by forgotten initialisation */
  swift_assert(p->_accessor_id != 0);
  /* Make sure we're accessing the correct data */
...
static __attribute__((always_inline)) INLINE const float*
  ...
  const struct part_density4* restrict part_density4_s = p->_cell_part_arrays->_part_density4 + p->_cell_offset;
#ifdef SWIFT_DEBUG_CHECKS
  /* Forbid ID = 0 to prevent false positives by forgotten initialisation */
  swift_assert(p->_accessor_id != 0);
  /* Make sure we're accessing the correct data */
...
static __attribute__((always_inline)) INLINE float
  ...
  if(part_density4_s->_accessor_id != p->_accessor_id)
    error("Accessor IDs not equal: %lld %lld", part_density4_s->_accessor_id, p->_accessor_id);
#endif
  return part_density4_s->_rot_v[i];
}
...
static __attribute__((always_inline)) INLINE float
  ...
  const struct part_force4* restrict part_force4_s = p->_cell_part_arrays->_part_force4 + p->_cell_offset;
#ifdef SWIFT_DEBUG_CHECKS
  /* Forbid ID = 0 to prevent false positives by forgotten initialisation */
  swift_assert(p->_accessor_id != 0);
  /* Make sure we're accessing the correct data */
...
static __attribute__((always_inline)) INLINE float
  ...
  const struct part_force5* restrict part_force5_s = p->_cell_part_arrays->_part_force5 + p->_cell_offset;
#ifdef SWIFT_DEBUG_CHECKS
  /* Forbid ID = 0 to prevent false positives by forgotten initialisation */
  swift_assert(p->_accessor_id != 0);
  /* Make sure we're accessing the correct data */
...
static __attribute__((always_inline)) INLINE float*
  ...
  struct part_force5* restrict part_force5_s = p->_cell_part_arrays->_part_force5 + p->_cell_offset;
#ifdef SWIFT_DEBUG_CHECKS
  /* Forbid ID = 0 to prevent false positives by forgotten initialisation */
  swift_assert(p->_accessor_id != 0);
  /* Make sure we're accessing the correct data */
...
static __attribute__((always_inline)) INLINE float
  ...
  const struct part_force6* restrict part_force6_s = p->_cell_part_arrays->_part_force6 + p->_cell_offset;
#ifdef SWIFT_DEBUG_CHECKS
  /* Forbid ID = 0 to prevent false positives by forgotten initialisation */
  swift_assert(p->_accessor_id != 0);
  /* Make sure we're accessing the correct data */
...
static __attribute__((always_inline)) INLINE struct adaptive_softening_part_data
  ...
  const struct part_additional_structs* restrict part_additional_structs_s = p->_cell_part_arrays->_part_additional_structs + p->_cell_offset;
#ifdef SWIFT_DEBUG_CHECKS
  /* Forbid ID = 0 to prevent false positives by forgotten initialisation */
  swift_assert(p->_accessor_id != 0);
  /* Make sure we're accessing the correct data */
...
static __attribute__((always_inline)) INLINE struct rt_timestepping_data
  ...
  const struct part_rt_time_data* restrict part_rt_time_data_s = p->_cell_part_arrays->_part_rt_time_data + p->_cell_offset;
#ifdef SWIFT_DEBUG_CHECKS
  /* Forbid ID = 0 to prevent false positives by forgotten initialisation */
  swift_assert(p->_accessor_id != 0);
  /* Make sure we're accessing the correct data */
...
static __attribute__((always_inline)) INLINE struct rt_timestepping_data*
  ...
  struct part_rt_time_data* restrict part_rt_time_data_s = p->_cell_part_arrays->_part_rt_time_data + p->_cell_offset;
#ifdef SWIFT_DEBUG_CHECKS
  /* Forbid ID = 0 to prevent false positives by forgotten initialisation */
  swift_assert(p->_accessor_id != 0);
  /* Make sure we're accessing the correct data */
...
static __attribute__((always_inline)) INLINE char
  ...
  const struct part_depth_h* restrict part_depth_h_s = p->_cell_part_arrays->_part_depth_h + p->_cell_offset;
#ifdef SWIFT_DEBUG_CHECKS
  /* Forbid ID = 0 to prevent false positives by forgotten initialisation */
  swift_assert(p->_accessor_id != 0);
  /* Make sure we're accessing the correct data */
...
static __attribute__((always_inline)) INLINE timebin_t
  ...
  const struct part_time_bin* restrict part_time_bin_s = p->_cell_part_arrays->_part_time_bin + p->_cell_offset;
#ifdef SWIFT_DEBUG_CHECKS
  /* Forbid ID = 0 to prevent false positives by forgotten initialisation */
  swift_assert(p->_accessor_id != 0);
  /* Make sure we're accessing the correct data */
...
static __attribute__((always_inline)) INLINE timebin_t*
  ...
  struct part_time_bin* restrict part_time_bin_s = p->_cell_part_arrays->_part_time_bin + p->_cell_offset;
#ifdef SWIFT_DEBUG_CHECKS
  /* Forbid ID = 0 to prevent false positives by forgotten initialisation */
  swift_assert(p->_accessor_id != 0);
  /* Make sure we're accessing the correct data */
...
static __attribute__((always_inline)) INLINE struct timestep_limiter_data
  ...
  const struct part_limiter_data* restrict part_limiter_data_s = p->_cell_part_arrays->_part_limiter_data + p->_cell_offset;
#ifdef SWIFT_DEBUG_CHECKS
  /* Forbid ID = 0 to prevent false positives by forgotten initialisation */
  swift_assert(p->_accessor_id != 0);
  /* Make sure we're accessing the correct data */
...
#ifdef SWIFT_DEBUG_CHECKS
  const struct part_ti_drift* restrict part_ti_drift_s = p->_cell_part_arrays->_part_ti_drift + p->_cell_offset;
...
#ifdef SWIFT_DEBUG_CHECKS
  const struct part_ti_kick* restrict part_ti_kick_s = p->_cell_part_arrays->_part_ti_kick + p->_cell_offset;
...
#ifdef SWIFT_DEBUG_CHECKS
  struct part_ti_kick* restrict part_ti_kick_s = p->_cell_part_arrays->_part_ti_kick + p->_cell_offset;
...
#ifdef SWIFT_HYDRO_DENSITY_CHECKS
  const struct part_debugging* restrict part_debugging_s = p->_cell_part_arrays->_part_debugging + p->_cell_offset;
#ifdef SWIFT_DEBUG_CHECKS
  /* Forbid ID = 0 to prevent false positives by forgotten initialisation */
  swift_assert(p->_accessor_id != 0);
  /* Make sure we're accessing the correct data */
...
#endif /* SWIFT_HYDRO_PART_05847d45e47b9b47b82a02fc014073908d4f3d5a_H */
