...
#define SWIFT_CONFIG_FLAGS                                            \
  ...
  "fftw-3.3.10-givtmlo3h55nhptjqeryfu46pzqc7zv6 "                     \
  "--with-hdf5=/home/mivkov/software/spack/opt/spack/linux-icelake/"  \
  "hdf5-1.14.5-drfzna3osvifsnxt75mejezr5efw6gg6/bin/h5cc "            \
  "--with-cuda=/opt/cuda --disable-mpi --enable-option-checking "     \
  "--enable-compiler-warnings --enable-debug --enable-debugging-checks"
